    ...
    <div id="heading-breadcrumbs">
      <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
          <div class="col-md-7">
            <h1 class="h2">Checkout - Metodo de entrega</h1>
          </div>
          <div class="col-md-5">
            <ul class="breadcrumb d-flex justify-content-end">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Checkout - Metodo de entrega</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="box">
              <form method="post" action="shop-checkout3.html">
                <ul class="nav nav-pills nav-fill">
                  ...
                  <li class="nav-item"><a href="shop-checkout2.html" class="nav-link active"><i class="fa fa-truck"></i><br>Metodo de entrega</a></li>
                ...
                <div class="content">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="box shipping-method">
                        <h4>Normal</h4>
                        <p>Entre el 1 de mayo y 5 de mayo.</p>
                        <div class="box-footer text-center">
                    ...
                    <div class="col-sm-6">
                      <div class="box shipping-method">
                        ...
                        <p>Retiro en los proximos 7 dias.</p>
                        <div class="box-footer text-center">
                          <input type="radio" name="delivery" value="delivery3">
                        </div>
                      </div>
                ...
                <div class="box-footer d-flex flex-wrap align-items-center justify-content-between">
                  <div class="left-col"><a href="shop-checkout1.html" class="btn btn-secondary mt-0"><i class="fa fa-chevron-left"></i>Volver a direccion</a></div>
                  <div class="right-col">
                    <button type="submit" class="btn btn-template-main">Continuar con el metodo de pago<i class="fa fa-chevron-right"></i></button>
                  </div>
                </div>
              </form>
            </div>
