    ...
    <div id="heading-breadcrumbs">
      <div class="container">
        <div class="row d-flex align-items-center flex-wrap">
          <div class="col-md-7">
            <h1 class="h2">Checkout - Metodo de pago</h1>
          </div>
          <div class="col-md-5">
            <ul class="breadcrumb d-flex justify-content-end">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Checkout - Metodo de pago</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="box">
              <form method="post" action="shop-checkout4.html">
                <ul class="nav nav-pills nav-fill">
                  ...
                  <li class="nav-item"><a href="shop-checkout3.html" class="nav-link active"><i class="fa fa-money"></i><br>Metodo de pago</a></li>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="box payment-method">
                        <h4>MercadoPago</h4>
                        <p>El metodo de pago mas utilizado en latinoamerica</p>
                    ...
                    <div class="col-sm-6">
                      <div class="box payment-method">
                        <h4>Cash (Pago en sucursal)</h4>
                        <p>Pagas cuando llegas.</p>
                        <div class="box-footer text-center">
                ...
                <div class="box-footer d-flex flex-wrap align-items-center justify-content-between">
                  <div class="left-col"><a href="shop-checkout2.html" class="btn btn-secondary mt-0"><i class="fa fa-chevron-left"></i>Volver a metodo de entrega</a></div>
                  <div class="right-col">
                    <button type="submit" class="btn btn-template-main">Resumen del pedido<i class="fa fa-chevron-right"></i></button>
                  </div>
                </div>
              </form>
            </div>
