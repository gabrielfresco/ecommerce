            ...
            <section class="no-padding-top no-padding-bottom">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col">
                        <div class="block">
                           <div class="title"><strong class="d-block">Nuevo Producto</strong><span class="d-block"></span></div>
                           ...
                           <div class="form-group">
                                  ...
                                  <div class="form-group">       
                                    <label class="form-control-label">Largo del producto</label>
                                    <input type="text" placeholder="Largo" id="length" class="form-control">
                                  </div>
                                  <div class="form-group">       
                                        <label class="form-control-label">Ancho del producto</label>
                                        <input type="text" placeholder="Ancho" id="width" class="form-control">
                                    </div>
                                      <div class="form-group">       
                                    ...
                                    <div class="form-group">       
                                            ...
                                            <input type="text" placeholder="Precio" id="price" class="form-control">
                                    </div>
                                    <div class="form-group">       
                                            <label class="form-control-label">Garantia</label>
                                            <input type="text" placeholder="Garantia" id="warranty" class="form-control">
                                    </div>
                              <div class="form-group">       
                                 <input type="submit" value="Agregar" onclick="insertProduct()" class="btn btn-primary">
                              </div>
                              <div class="form-group">
                                 <div id="message"></div>
                              </div>
