      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header"><a href="index.html" class="navbar-brand">
              ...
              <div class="brand-text brand-sm"><strong class="text-primary">A</strong><strong>D</strong><strong class="text-primary">M</strong></div></a>
            ...
            <li class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1">5</span></a>
              <ul aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages">
                <li><a href="#" class="dropdown-item message d-flex align-items-center">
                    ...
                    <div class="content">   <strong class="d-block">Notificacion 1</strong><span class="d-block">descripcion</span><small class="date d-block">9:30am</small></div></a></li>
                <li><a href="#" class="dropdown-item message d-flex align-items-center">
                    <div class="profile"><img src="img/avatar-2.jpg" alt="..." class="img-fluid">
                      <div class="status away"></div>
                    </div>
                    <div class="content">   <strong class="d-block">Notificacion 2</strong><span class="d-block">descripcion</span><small class="date d-block">7:40am</small></div></a></li>
                <li><a href="#" class="dropdown-item message d-flex align-items-center">
                    <div class="profile"><img src="img/avatar-1.jpg" alt="..." class="img-fluid">
                      <div class="status busy"></div>
                    </div>
                    <div class="content">   <strong class="d-block">Notificacion 3</strong><span class="d-block">descripcion</span><small class="date d-block">6:55am</small></div></a></li>
                <li><a href="#" class="dropdown-item message d-flex align-items-center">
                    <div class="profile"><img src="img/avatar-5.jpg" alt="..." class="img-fluid">
                      <div class="status offline"></div>
                    </div>
                    <div class="content">   <strong class="d-block">Notificacion 4</strong><span class="d-block">descripcion</span><small class="date d-block">10:30pm</small></div></a></li>
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          <li><a href="index.php"><i class="icon-home"></i>Inicio</a></li>
            ...
            <li><a href="#dashvariants" aria-expanded="false" data-toggle="collapse"> <i class="icon-grid"></i>Productos </a>
          ...
          <li><a href="#dashsite" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-university"></i>Sitio</a>
        ...
        <section class="no-padding-top no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
                    <div class="col">
                            <div class="block">
                              <div class="title"><strong class="d-block">Nuevo Pais</strong><span class="d-block"></span></div>
                              <div class="block-body">
                                  <div class="form-group">
                                    <label class="form-control-label">Nombre del Pais</label>
                                    <input type="text" id="nombre" placeholder="Pais" class="form-control">
                                  </div>
                                  <div class="form-group">       
                                    <label class="form-control-label">Codigo Pais</label>
                                    <input type="text" id="codigo" placeholder="Ej: 54" class="form-control">
                                  </div>
                                  <div class="form-group">       
                                    <input type="submit" value="Agregar" onclick="insertCountry()" class="btn btn-primary">
                                  </div>
                                  <div class="form-group">       
                                    <div id="message"></div>
                                  </div>
                          ...
                          <div class="col">
                                <div class="block margin-bottom-sm">
                                  <div class="title"><strong>Lista de Paises</strong></div>
                                  <table class="table">
                                    <thead>
                                      <tr>
                                        <th>#</th>
