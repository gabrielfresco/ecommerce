                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div contentEditable='true' class='edit-country' id='name_<?php echo $pais["idCountry"]; ?>'><?php echo $pais["name"]; ?></div>
                                       </td>
                                       <td><input type="submit" value="Eliminar" onclick="eliminarCountry(<?php echo $pais["idCountry"]; ?>)" class="btn btn-primary"></td>
                                    </tr>
                                    <?php
                                       $count++;
                                       }
