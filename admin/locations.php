            ...
            <section class="no-padding-top no-padding-bottom">
               <div class="container-fluid">
                  <div class="row">
                     <div class="col">
                        <div class="block">
                           <div class="title"><strong class="d-block">Nueva Localidad</strong><span class="d-block"></span></div>
                           <div class="block-body">
                              <div class="form-group">
                                 <label class="form-control-label">Nombre de la localidad</label>
                                 <input type="text" id="nombre" placeholder="Localidad" class="form-control">
                              </div>
                              <div class="form-group">     
                              <label class="form-control-label">Ciudad</label>  
                                 <select class="form-control" id="codigoCity">
                                <?php
                                    $ciudades = cityListar();
                                    foreach ($ciudades as $ciudad)
                                    {
                                ?>
                                 <option value="<?php echo $ciudad["idCity"];?>"><?php echo $ciudad["name"]; ?></option>
                                    <?php } ?>
                                 </select>
                              </div>
                              <div class="form-group">       
                                 <input type="submit" value="Agregar" onclick="insertLocation()" class="btn btn-primary">
                              </div>
                              <div class="form-group">
                                 <div id="message"></div>
                              </div>
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                       <div contentEditable='true' class='edit-location' id='name_<?php echo $localidad["idLocation"]; ?>'><?php echo $localidad["name"]; ?></div>
                                       </td>
                                       <td>
                                          <?php 
                                          $ciudad = new City();
                                          $ciudad->findCityById($localidad["idCity"]);
                                          echo $ciudad->name;
                                          ?>
                                       </td>
                                       <td><input type="submit" value="Eliminar" onclick="eliminarLocation(<?php echo $localidad["idLocation"]; ?>)" class="btn btn-primary"></td>
                                    </tr>
                                    <?php
                                       $count++;
                                       }
