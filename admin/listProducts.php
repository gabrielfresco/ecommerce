                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          $categoria->findCategoryById($producto["idCategory"]);
                                          echo $categoria->name;
                                          ?>
                                       </td>
                                       ...
                                       <td>
                                        ...
                                        <input type="submit" value="Eliminar" onclick="eliminarProduct(<?php echo $producto["idProduct"]; ?>)" class="btn btn-primary">
                                      </td>
                                    </tr>
                                    <?php
                                       $count++;
